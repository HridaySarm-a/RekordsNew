...
import com.main.rekordsnew.databinding.FragmentAdminMedicalBinding;

public class AdminMedicalFragment extends Fragment {

    FragmentAdminMedicalBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        binding = FragmentAdminMedicalBinding.inflate(getLayoutInflater());
        initButtons();
        return binding.getRoot();
    }

    private void initButtons() {
        binding.adminMedicalAdeCvBtn.setOnClickListener(view -> {
            ...
            editOrDeleteBtn.setOnClickListener(v3 -> {
                ShowClientsBottomSheetDialogFragment showClientsBottomSheetDialogFragment = new ShowClientsBottomSheetDialogFragment(Global.medicalRef);
