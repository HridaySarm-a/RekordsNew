...
import com.main.rekordsnew.Interface.TableDataSource;
import com.main.rekordsnew.R;

public class ChallanTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    public ChallanTableAdapter(Context context, TableDataSource<String, String, String, String> tableDataSource) {
